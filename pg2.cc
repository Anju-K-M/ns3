...
std::string tracebase = "scratch/wire";
...
int main (int argc, char *argv[])
{
  ...
  int brheight = 150;            // height of bottom row
...
// packets are marked in the tracefile with ns3::SeqTsHeader, including sequence numbers
  ...
  for(int i=0;i<=2;i++)anim.UpdateNodeSize(i,25.0,25.0);
  anim.UpdateNodeSize(3,75.0,75.0);
  anim.UpdateNodeImage (3, anim.AddResource ("/home/user/Documents/i.png") );
  anim.SetBackgroundImage("/home/user/Downloads/roa.png",-10.0, -10.0, 0.60, 0.60, 1.0);
